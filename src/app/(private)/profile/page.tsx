...
import RacesTab from '@/components/profile-tabs/RacesTab';
import BadgesTab from '@/components/profile-tabs/BadgesTab';
import ReferTab from '@/components/profile-tabs/ReferTab';
...
export default function Profile() {
    const tabs = [
        ...
        { label: 'Races', content: <RacesTab /> },
        { label: 'Badges', content: <BadgesTab /> },
        { label: 'Refer to Earn', content: <ReferTab /> }
    ];
    ...
    return <div className="h-full w-full left-[148px] bg-shadow-black  pt-[58px]">
        ...
        <div className='flex flex-col items-center'>
            <div className="z-10 pt-10 w-[976px]">
                <div className='flex mb-10 justify-between'>
                    <h1 className="text-gold text-3xl font-medium">Player Center</h1>
                    <ButtonSettings />
                </div>
                <div className="px-8 py-5 bg-main-purple-lighter rounded flex gap-8 place-content-between">
            ...
            <div className='flex mt-6 mb-10 relative  gap-x-3 w-[976px]'>
                <div className='w-1/2 rounded bg-shadow-grey1 py-7 pl-7 pr-16'>
                    ...
                    <div className='flex gap-x-9'>
                        <div className='font-medium'>
                            <p className='mb-1 text-sm text-shadow-grey4'>Ranked top 10</p>
                            <h1 className='text-4xl	text-white'>88%</h1>
                        </div>
                        <div className='font-medium'>
                            <p className='mb-1 text-sm text-shadow-grey4'>Races completed</p>
                            <h1 className='text-4xl	text-white'>122</h1>
                        </div>
                        <div className='font-medium'>
                            <p className='mb-1 text-sm text-shadow-grey4'>Race Champions</p>
                ...
                <div className='w-1/2 rounded bg-shadow-grey1 py-7 pl-7 pr-16'>
                    ...
                    <div className='flex gap-x-9'>
                        <div className='font-medium'>
                            <p className='mb-1 text-sm text-shadow-grey4'>Punts winning rate</p>
                            <h1 className='text-4xl	text-white'>88%</h1>
                        </div>
                        <div className='font-medium'>
                            <p className='mb-1 text-sm text-shadow-grey4'>Total Punts #</p>
                            <h1 className='text-4xl	text-white'>12,888</h1>
                        </div>
                        <div className='font-medium'>
                            <p className='mb-1 text-sm text-shadow-grey4'>Total Return</p>
